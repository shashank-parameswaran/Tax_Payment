...
import numpy as np # Numpy version 1.20.3
from IPython.display import display, HTML
import pandas as pd # Pandas version 1.3.4


from pyspark.sql import SparkSession # PySpark version 3.4.1
...
from sklearn.metrics import confusion_matrix, accuracy_score, f1_score, precision_score, recall_score, ConfusionMatrixDisplay # Scikit-learn version 0.24.2
import os
import findspark
findspark.init()
findspark.find()
...
class LatePaymentClassifier:
    ...
    def __init__(self,
                 file1=None, # Year1 Master data 
                 file2=None, # Year2 Master data
                 file3=None, # Year3 Master data
                 file4=None, # Year4 Master data
                 fileCurrentYear=None, # Current Year data - to be predicted
                 fileHeader=None,  # Header file
                 fileDueDates=None, # Updated Tax Due dates csv file
                 pmtFile1=None, # Year1 Payment Master data
                 pmtFile2=None, # Year2 Payment Master data
                 pmtFile3=None, # Year3 Payment Master data
                 pmtFile4=None, # Year4 Payment Master data
                 pmtCurrentYear=None, # Current Year data
                 currentYear = None # current year value
                ):
    ...
    def readData(self):
        ...
        data = data.where(~((data.DiffPmt2>=500) & (data.TaxYear!=self.currentYear)))
        data = data.where(~((data.DiffPmt1>=680) & (data.TaxYear!=self.currentYear)))
    ...
    def getFeatureImportance(self):
        print("Retrieving the most important features.....")
    ...
    def exportToCSV(self, filename="Predictions.csv"):
        ...
        outDf = outDf.withColumn("prediction", col("prediction").cast("int"))
        outDf.toPandas().to_csv(filename)
